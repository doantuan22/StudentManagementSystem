...
public class StudentFormDialog extends JDialog {
    ...
    private final JComboBox<ClassRoom> classRoomComboBox = new JComboBox<>();
    ...
    private final List<ClassRoom> allClassRooms;
    private final ClassRoom preferredClassRoom;
    ...
    private StudentFormDialog(Component parent, StudentFormModel model) {
        ...
        this.preferredClassRoom = model.selectedClassRoom();
    ...
    private void initComponents(StudentFormModel model) {
        ...
        facultyComboBox.addActionListener(event -> reloadClassRoomOptions(null));
    ...
    private void bindModel(StudentFormModel model) {
        ...
        reloadClassRoomOptions(preferredClassRoom);
    ...
    private JPanel createAcademicInfoSection() {
        ...
        contentPanel.add(createField("Lớp", styleComboBox(classRoomComboBox)), fieldConstraints(1, 0));
        contentPanel.add(createField("Niên khóa", styleTextField(academicYearField)), fieldConstraints(0, 1));
        contentPanel.add(createField("Trạng thái", styleComboBox(statusComboBox)), fieldConstraints(1, 1));
    ...
    private void reloadClassRoomOptions(ClassRoom selectedClassRoom) {
        ...
        if (selectedClassRoom != null) {
            classRoomComboBox.setSelectedItem(selectedClassRoom);
        }
    }
